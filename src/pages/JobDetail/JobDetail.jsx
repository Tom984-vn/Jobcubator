        ...
        <div className="grid grid-cols-3">
          <div className="col-span-2">
            <div className="bg-white rounded-lg p-5">
              <h1 className="raleway-bold text-2xl">{testJobData.jobname}</h1>
                ...
                <div className="flex items-center gap-3 ">
                  ...
                  <div>
                    ...
                    <p className="inline text-md font-semibold text-primary-400">
                      {testJobData.salaryMin} - {testJobData.salaryMax}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3 ">
            ...
            <div className="bg-white rounded-lg p-5 mt-10">
              ...
              <div className="mt-5">
                ...
                <p className="mt-2 text-justify">- {testJobData.applyMethod}</p>
              </div>
              <p className="mt-3">Hạn nộp hồ sơ: {testJobData.deadline}</p>
              <div className="flex gap-4 mt-4">
                <button className="bg-secondary-2-300 flex items-center justify-center w-[75%] text-white px-4 py-1 rounded-md hover:bg-secondary-2-400 transition">
                  <IoMdPaperPlane className="inline mr-2" />
                  Ứng tuyển ngay
          ...
          <div className="col-span-1 ml-5">
            <div className="bg-white rounded-lg p-5 sticky top-20">
              <div className="flex gap-2">
                ...
                />
                <h2 className="raleway-bold text-lg">{testCompanyData.name}</h2>
              </div>
            ...
            <div className="bg-white rounded-lg p-5 sticky top-100 mt-10 ">
