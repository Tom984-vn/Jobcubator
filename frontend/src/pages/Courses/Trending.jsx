...
export default function Trending() {
  ...
  return (
    <div className="w-[90%] mx-auto pb-10 ">
      <h1 className="raleway-bold text-2xl">Các kỹ năng nổi bật</h1>
      <p className="w-[75%]">
        Khám phá các kỹ năng đang được săn đón nhất trên thị trường lao động
        hiện nay. Nâng cao kỹ năng của bạn để đáp ứng nhu cầu của nhà tuyển dụng
